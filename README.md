# hello-world
it is my first github interaction at mdx. On GitHub, saved changes are called commits. Commits are pretty glorious, because a bunch of them together read like the history of your project.
